    ...
    <div>
         ...
         <div>
          ...
          <select id="faculty" value={formData.faculty} onChange={handleChange} required >
            ...
            <option value="karthik">37-38 karthik</option>
            <option value="ashok">37-38 ashok</option>
            <option value="srinivas">37-38 srinivas</option>
            <option value="rajesh">37-38 rajesh</option>
            <option value="rajeswari">37-38 rajeswari</option>
